...
$this->title = 'Administration Department';
?>
<div class="">
                ...
                <ol role="list" class="flex items-center space-x-4">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="#" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Department</a>
                        </div>
                    </li>
                </ol>
            </nav>
            <h2 class="mt-2 text-2xl text-gray-900 sm:truncate sm:text-2xl sm:tracking-tight">Departments</h2>
        </div>
                    ...
                    <div class="p-6">
                        ...
                        <div>
                            <div class="mt-2">
                                ...
                                <label for="employe" class="block text-sm font-medium leading-6 text-gray-900">Manager</label>
                                <div class="mt-2 border rounded-md">
                                ...
                                <label for="employe" class="block text-sm font-medium leading-6 text-gray-900">Parent Departemen</label>
                                <div class="mt-2 border rounded-md">
                                    <div class="flex border rounded-lg">
                                        <div x-data="Components.menu({ open: true })" x-init="init()" @keydown.escape.stop="open = false; focusButton()" @click.away="onClickAway($event)" class="relative inline-block text-left">
                                            <div>
                                ...
                                <label for="employe" class="block text-sm font-medium leading-6 text-gray-900">Location</label>
                                <div class="mt-2 border rounded-md">
                                    <input type="text" employe="employe" id="employe" class="block w-full px-3 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Enter Employess">
                                </div>
                                <label for="employe" class="block text-sm font-medium leading-6 text-gray-900">Work Shift</label>
                                <div class="mt-2 border rounded-md">
                                    <input type="text" employe="employe" id="employe" class="block w-full px-3 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Enter Employess">
                                </div>
        ...
        <table class="w-full">
            <thead>
                <tr class="bg-gray-50 text-left">
                    ...
                    <th class="px-4 py-2">Parent Department</th>
