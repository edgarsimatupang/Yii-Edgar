...
$this->title = 'Administration Shift ';
?>
<div class="">
                ...
                <ol role="list" class="flex items-center space-x-4">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="#" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Shift</a>
                        </div>
                    </li>
                </ol>
            </nav>
            <h2 class="mt-2 text-2xl text-gray-900 sm:truncate sm:text-2xl sm:tracking-tight">Shift</h2>
        </div>
                    ...
                    <div class="p-6">
                        ...
                        <div>
                            <div class="mt-2">
                                ...
                                <label for="employe" class="block text-sm font-medium leading-6 text-gray-900">Working Shift Type</label>
                                <div class="mt-2 border rounded-md">
                                ...
                                <label for="employe" class="block text-sm font-medium leading-6 text-gray-900">Start Time </label>
                                <div class="mt-2 border rounded-md">
                                    <input type="date" employe="employe" id="employe" class="block w-full px-3 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Enter Employess">
                                </div>
                                <label for="employe" class="block text-sm font-medium leading-6 text-gray-900">End Time</label>
                                <div class="mt-2 border rounded-md">
                                    <input type="date" employe="employe" id="employe" class="block w-full px-3 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Enter Employess">
                                </div>
                            </div>
