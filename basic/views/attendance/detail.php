                ...
                <ol role="list" class="flex items-center space-x-4">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="#" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Detail</a>
                        </div>
                    </li>
                </ol>
            </nav>
            <h2 class="mt-2 text-2xl text-gray-900 sm:truncate sm:text-2xl sm:tracking-tight">Attendance Details</h2>
        </div>
    ...
    <div class=" bg-white rounded-lg shadow-md mt-4">
        ...
        <div class="overflow-x-auto mx-4">
            <table class="min-w-full bg-white">
                <thead>
                    <tr class="bg-gray-50 text-left text-sm text-gray-900">
                        <th class="px-4 py-2">Profile</th>
                        <th class="px-4 py-2">Januari</th>
                        <th class="px-4 py-2">Februari Out</th>
                        <th class="px-4 py-2">Maret</th>
                        <th class="px-4 py-2">April </th>
                        <th class="px-4 py-2">Mei</th>
                        <th class="px-4 py-2">Juni</th>
                        <th class="px-4 py-2">Juli In</th>
                        <th class="px-4 py-2">Agustus</th>
                        <th class="px-4 py-2">September</th>
                        <th class="px-4 py-2">Oktober</th>
                        <th class="px-4 py-2">November</th>
                        <th class="px-4 py-2">Desmber</th>
                    </tr>
                </thead>
                <tbody>
                    <?php for ($i = 0; $i < 5; $i++): ?>
                    <tr class="py-2">
                        <td class="px-4 py-2 whitespace-nowrap">
                            <div class="flex items-center">
                                <img class="inline-block h-8 w-8 rounded-full mr-2" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="">
                                <span>Bayu</span>
                            </div>
                        </td>
